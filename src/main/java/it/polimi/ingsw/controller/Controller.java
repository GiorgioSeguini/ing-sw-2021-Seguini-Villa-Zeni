...
public class Controller {
    ...
    * dove da 0 a 3 sono esattamente le 4 colonne e da 4 a 6 siano le tre righe */
    ...
    public void BuyFromMarket(int indextobuy, Market market, Player player){
        ArrayList<ResourceType> buyedresources=new ArrayList<>();
        ...
        switch (indextobuy){
            case 0: buyedresources=market.buyColumn(0); break;
            case 1: buyedresources=market.buyColumn(1); break;
            case 2: buyedresources=market.buyColumn(2); break;
            case 3: buyedresources=market.buyColumn(3); break;
            case 4: buyedresources=market.buyRow(0); break;
            case 5: buyedresources=market.buyRow(1); break;
            case 6: buyedresources=market.buyRow(2); break;
        }
        try{
